// You are a financial institution, your program needs to keep track of customer data.
fn main() {
 // TODO: Create 3 variables to:
 ...
 let name = "john doe";
 let balance: f32 = 31.3;
 let status: bool = true;

 println!("{}, {}, {}", name, balance, status);
}